...
export const AppState = reactive({
    ...
    portfolio:[
        ...
        },
        {
            ...
            img:'src/assets/img/keepr/keepr_1080.jpg', 
            logo:'src/assets/img/keepr/logo.svg', 
            description: 'This is one of my original projects from my time as enrolled in codeworks and is my first project using the MVC design pattern. The app is barebones, uses no modern tech like Vue or React, and only uses local storage, but I think it is a solid foundation, if not a particularly modernized one.',

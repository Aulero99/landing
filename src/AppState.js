...
export const AppState = reactive({
    ...
    portfolio:[
        ...
        },
        {
            ...
            description: 'Recipeasy allows users to store food in their "pantry", tracks how fresh that food is, then suggests recipes to the user based on the food they have. Once the user finds a recipe, they simply press a button and the ingredients are subtracted from their pantry, and if they run out it automatically adds them to their shopping list.',
